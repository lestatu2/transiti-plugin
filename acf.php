...
function transiti_register_acf_configuration_fields(): void
{
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            array(
                'key' => 'field_transiti_mission_title',
                'label' => __('Titolo mission', 'transiti'),
                'name' => 'mission_title',
                'type' => 'text',
            ),
            array(
                'key' => 'field_transiti_mission_subtitle',
                'label' => __('Sottotitolo mission', 'transiti'),
                'name' => 'mission_subtitle',
                'type' => 'text',
            ),
            array(
                'key' => 'field_transiti_mission_summary',
                'label' => __('Riassunto mission', 'transiti'),
            ...
            array(
                ...
                'label' => __('Testo mission', 'transiti'),
                'name' => 'mission',
                'type' => 'wysiwyg',
                'tabs' => 'all',
                'toolbar' => 'full',
            ...
            array(
                'key' => 'field_transiti_mission_image',
                'label' => __('Immagine mission', 'transiti'),
                'name' => 'mission_image',
                'type' => 'image',
                'return_format' => 'id',
                'preview_size' => 'medium',
            ...
            array(
                'key' => 'field_transiti_mission_author',
                'label' => __('Autore mission', 'transiti'),
                'name' => 'mission_author',
                'type' => 'text',
            ),
            array(
